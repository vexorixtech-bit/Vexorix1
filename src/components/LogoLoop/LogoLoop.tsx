import { useCallback, useEffect, useMemo, useRef, useState, memo, type CSSProperties, type Key, type ReactNode, type RefObject } from 'react';
import './LogoLoop.css';
...
const useResizeObserver = (
  ...
  }, [callback as unknown as (() => void), elements, ...dependencies]);
};
...
export const LogoLoop = memo(
  ({
    ...
    useImageLoader(seqRef as RefObject<HTMLElement | null>, updateDimensions, [logos, gap, logoHeight, isVertical]);
