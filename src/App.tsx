...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <a href="https://wa.me/919655058949?text=Hi%20Vexorix,%20I'm%20interested%20in%20your%20web%20development%20services." target="_blank" rel="noopener noreferrer" className="fixed bottom-6 left-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-2xl shadow-lg hover:scale-110 transition-transform z-40" aria-label="WhatsApp">
