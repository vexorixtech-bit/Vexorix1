...
const projects = [
  { id: 1, category: 'Business', title: 'Restaurant Website', img: 'https://images.pexels.com/photos/36749693/pexels-photo-36749693.jpeg', tech: ['React', 'Node.js', 'MongoDB'], desc: 'Online reservation-enabled restaurant website designed to improve customer engagement and increase bookings.', demo: 'https://u-me-couple-cafe.vercel.app/' },
  ...
  { id: 5, category: 'Fitness', title: 'Gym & Fitness Website', img: 'https://images.pexels.com/photos/17211446/pexels-photo-17211446.jpeg', tech: ['React', 'Node.js', 'MongoDB'], desc: 'High-conversion fitness website to boost memberships and highlight training programs.', demo: 'https://vikramgym.vercel.app/' },
  ...
  { id: 7, category: 'Real Estate', title: 'Real Estate Website', img: 'https://images.pexels.com/photos/27307399/pexels-photo-27307399.jpeg', tech: ['React', 'Node.js', 'PostgreSQL'], desc: 'Modern real estate platform for showcasing properties and capturing buyer enquiries.', demo: 'https://real-estate-project-rose-tau.vercel.app/' },
  { id: 8, category: 'Business', title: 'Business Website', img: 'https://images.pexels.com/photos/1604024/pexels-photo-1604024.jpeg', tech: ['React', 'Node.js', 'MongoDB'], desc: 'Professional business website designed for new companies to establish a strong online presence, showcase services, and attract potential clients from day one.', demo: '#' },
]
      ...
      <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20 fade-in">
        ...
        <div className="relative z-10 text-center px-6 animate-slide-up">
          <div className="mb-8 inline-block">
            <img src="/vexorix.tech.png" alt="Vexorix Logo" className="w-40 h-40 md:w-60 md:h-60 mx-auto object-contain drop-shadow-[0_0_40px_rgba(255,215,0,0.5)] animate-float" style={{backgroundColor: 'transparent'}} />
          </div>
