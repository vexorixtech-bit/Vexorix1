...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <section id="contact" className="py-24 px-6 bg-[#12121a] scroll-mt-20 slide-in-left">
       ...
       <footer className="py-12 px-6 border-t border-[#1f1f2e]">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
          <div>
            <h2 className="text-2xl font-bold gradient-text">Vexorix</h2>
            <p className="text-gray-500 text-sm mt-1">© 2026 Vexorix. All rights reserved.</p>
          </div>
          <div className="flex gap-6">
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="w-10 h-10 glass rounded-full flex items-center justify-center hover:bg-[#FFD700]/20 transition-colors text-lg" aria-label="Instagram">
      ...
      <a href="https://wa.me/919655058949" target="_blank" rel="noopener noreferrer" className="fixed bottom-6 left-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-2xl shadow-lg hover:scale-110 transition-transform z-40" aria-label="WhatsApp">
