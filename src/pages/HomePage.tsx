...
const dockItems: DockItem[] = [
  ...
  { id: 'contact', label: 'Call', icon: <FaPhoneAlt size={20} /> },
...
const recentProjects = [
  { name: 'U-ME Couple Cafe', category: 'Café · Food & Beverage', initial: 'UC', image: '/U%20and%20Me%20.jpeg', preview: 'bg-gradient-to-br from-[#1f2937] to-[#111827]', desc: 'A warm, cozy online presence for a couple-themed café.', stack: ['React', 'Tailwind CSS', 'Vite'], url: 'https://u-me-couple-cafe.vercel.app/', icon: <UtensilsCrossed size={20} /> },
  { name: 'Pannai 2 Pattanam', category: 'Food & Agriculture', initial: 'P2', image: '/P2P%20IMAGES%20.jpeg', preview: 'bg-gradient-to-br from-[#14532d] to-[#052e16]', desc: 'A tasteful website showcasing local food & hospitality.', stack: ['React', 'Tailwind CSS', 'Vite'], url: 'https://pannai2-pattanam.vercel.app/', icon: <Sprout size={20} /> },
  { name: 'Nithish Makeup Artist', category: 'Makeup Artist', initial: 'NM', image: '/nithish%20makeup.png', preview: 'bg-gradient-to-br from-[#1c1917] to-[#292524]', desc: 'An elegant portfolio for bridal & professional makeup artistry.', stack: ['React', 'Tailwind CSS', 'Vite'], url: 'https://nithish-makeover-artistry.vercel.app/', icon: <Sparkles size={20} /> },
            ...
            {[
              ...
              >
                <div className="relative flex-1 overflow-hidden">
                  <div className="absolute inset-0 flex flex-col items-center justify-center text-center transition-opacity duration-300 group-hover/card:opacity-0">
                  ...
                  <div className="flex flex-col items-center justify-center min-h-full py-2 text-center opacity-0 transition-opacity duration-300 group-hover/card:opacity-100">
